...
import com.example.android.simplealarmmanagerapp.utilities.constants.TIME_TO_CLASS_ID
import khttp.patch
...
class BluetoothService : Service() {
    ...
    override fun onCreate() {
        Log.i(TAG, "onCreate()")
        preferences =
                applicationContext.getSharedPreferences(AUTH_PREFERENCE_NAME, Context.MODE_PRIVATE)
        preferencesTimeToClass =
                applicationContext.getSharedPreferences(TIME_TO_CLASS_ID, Context.MODE_PRIVATE)
        super.onCreate()
    }
    ...
    private val mReceiver = object : BroadcastReceiver() {
        ...
        fun createNotification(context: Context, deviceName: String, deviceHardwareAddress: String) {
            val builder = Notification.Builder(context)
                    ...
                    .setSmallIcon(R.drawable.ic_action_course_info)
